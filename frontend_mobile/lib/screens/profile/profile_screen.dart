...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: tokenService.getAccessToken == null
          ? Center(
              child: Text("Is Empty"),
            )
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const CustomDivider(),
                              ProfileSetting(
                                icon: Icon(Icons.work_outline).icon ??
                                    Icons.error,
                                title: 'Resume',
                                trailing: const Icon(
                                  Icons.arrow_forward_ios,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              ProfileSetting(
                                ...
                                onTap: () {
                                  Navigator.pushNamed(context,
                                      RouteManager.changePasswordScreen);
                                },
                              ),
                              // const CustomDivider(),
                              // ProfileSetting(
                              ...
                              const CustomDivider(),
                              ProfileSetting(
                                icon: Icon(Icons.policy_outlined).icon ??
                                    Icons.error,
                                ...
                                onTap: () {
                                  Navigator.pushNamed(context,
                                      RouteManager.termAndConditionScreen);
                                },
                              ),
                              const CustomDivider(),
                              ProfileSetting(
                              ...
                              const CustomDivider(),
                              ProfileSetting(
                                icon: Icon(Icons.logout_outlined).icon ??
                                    Icons.error,
                                title: 'Logout',
                                trailing: null,
                                onTap: () {
