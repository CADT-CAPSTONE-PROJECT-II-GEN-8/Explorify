            ...
            <section className="text-blueGray-700 bg-white mt-10">
              <div className="container flex flex-col items-center px-5 py-16 mx-auto md:flex-row lg:px-28">
                <div className="flex flex-col items-start mb-16 text-left lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:mb-0">
                  <h2 className="mb-8 text-xs font-semibold tracking-widest text-black uppercase title-font"> IT Solution </h2>
                  <h1 className="mb-8 text-xl font-black tracking-tighter text-black md:text-3xl title-font"> IT Solution </h1>
                  <p className="mb-8 text-base leading-relaxed text-left text-blueGray-600 "> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. </p>
        ...
        <span class="pl-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-amber-700 to-gray-600">About Company</span>
               ...
               <div class="pt-10 container mx-auto max-w-5xl grid gap-12 grid-cols-1 md:grid-cols-3 items-start justify-center">
                ...
                <div class="grid gap-6 justify-items-center text-center">
                    ...
                    <br />
                    <span className='font-normal text-center'>Our company have Hello  staff</span>
                    </h3>
                ...
                <div class="grid gap-6 justify-items-center text-center">
                    ...
                    <br />
                    <span className='font-normal text-center pt-2 text-blue-500 hover:underline'>Hello </span>
                    </h3>
